...
RSpec.describe TopicsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "DELETE destroy" do
      it "returns http redirect for admin user only" do
  ...
  context "moderator user" do
    before do
      user = User.create!(name: "Bloccit Moderator User", email: "moderator@bloccit.com", password: "helloworld", role: :moderator)
      create_session(user)
    end
